...
.slide-nav2 li:hover,.slide-nav2 ul .active{
    color: #179aff;
    padding-left: 40px;
    background: #fff;
}
...
.h-evaluatio .form-group .form-control2 {
    width: 42%;
    float: left;
    line-height: 14px;
    padding: 10px;
